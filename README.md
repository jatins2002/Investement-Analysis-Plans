...
Place the CSV file and notebook in the same folder.
...
If Power BI asks for the dataset location, update the CSV source path.

Refresh the data.

Open the report pages to explore the dashboard and correlation visuals.
